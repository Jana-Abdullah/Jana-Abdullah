<h2 align="left">👩‍💻 Hi, I'm Jana Abdullah</h2>
...
<h5 align="left">🚀 About Me<br>- Passionate about data and continuous learning  <br>- Interested in data analysis and visualization  <br>- Building real-world projects to improve my skills  <br>- Goal: become a professional data analyst<br><br>🧠 Skills<br>- SQL  <br>- Python  <br>- Excel  <br>- Data Cleaning  <br>- Data Analysis  <br>- Data Visualization  <br><br>📌 Projects
  <br><br>🛡️ AML & Liquidity Risk Analysis System (Python, SQL, Power BI)<br>
 • Developed an end-to-end AML analytics system to detect suspicious financial behavior and liquidity risks across banking networks.<br>
 • Built SQL investigation queries for rapid transfers, circular money movement, smurfing, and dormant account activity detection.<br>
 • Designed an interactive Power BI dashboard for behavioral risk profiling and financial risk monitoring.<br>
